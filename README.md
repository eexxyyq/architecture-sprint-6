...
GraphQL позволяет клиентам гибко запрашивать только нужные им данные. Например, клиент может запросить только имя и возраст клиента, без документов и родственников, если это необходимо.
Запросы GraphQL легко комбинируются, что позволяет за один запрос получить несколько связанных данных.

[Схема апи](Exc5/GraphQL.txt)

[Пример запроса](Exc5/request.txt)

[Пример ответа](Exc5/response.txt)

## Задание 6. Настройка Rate Limiting

[Файл конфигурации](Exc6/nginx.cfg)